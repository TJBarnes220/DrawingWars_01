 ...
 * enemies reside.
 */
public class TutorialGameBoard {
     ...
     */
    public TutorialGameBoard(int height, int width, TableLayout board, ArrayList<Entity> allEntities, Context app,TutorialBattle game){
        this.height = height;
        this.width = width;
        this.board = board;
            ...
            if(location.equals(potentialMovement.get(i))){
                ...
                if(((MovementAction) game.getCurrentAction()).getCurrentUses() == 0){
                    ...
                    switch(game.getCondition()){
                        case(0):
                            ((MovementAction) game.getCurrentAction()).setCurrentUses(2);
                            break;
                        case(1):
                            ((MovementAction) game.getCurrentAction()).setCurrentUses(2);
                            break;
