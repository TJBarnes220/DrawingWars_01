...
public class Display {
     ...
     */
    public Display(Battle game, Entity selected, Context app, ImageView stock, TextView health, TextView name, RecyclerView actions){
        this.appContext = app;
        ...
        if(selected instanceof Character) {
            ...
            adapter = new ItemListAdapter(appContext, ((Character)this.selected).getActions(), game);
    ...
    public void selection(Entity selected){
        if(selected instanceof Character) {
            ...
            selectedCharacterHealth.setText("HP:" + selected.getHealth() + " EP: " + ((EntityAE) selected).getCurrentEnergy());
            actionsList.setLayoutManager(new LinearLayoutManager(appContext, LinearLayoutManager.HORIZONTAL, false));
            ItemListAdapter adapter = new ItemListAdapter(appContext, ((Character)selected).getActions(), game);
            actionsList.setAdapter(adapter);
            ...
            selectedCharacterHealth.setText("HP:" + selected.getHealth());
            actionsList.setLayoutManager(new LinearLayoutManager(appContext, LinearLayoutManager.HORIZONTAL, false));
            ItemListAdapter adapter = new ItemListAdapter(appContext, ((Enemy)selected).getActions(), game);
            actionsList.setAdapter(adapter);
    ...
    public void update(){
        ...
        ((ItemListAdapter)actionsList.getAdapter()).update();
    }
}
